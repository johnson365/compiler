...
import codegen.C.exp.Length;
import codegen.C.stm.Block;
...
public class TranslateVisitor implements ast.Visitor
{
  ...
  @Override
  public void visit(ast.stm.AssignArray s)// id[indexexp] = exp;
  {
	 s.index.accept(this);
  ...
  public void scanClasses(java.util.LinkedList<ast.classs.T> cs)
  {
    ...
    for (ast.classs.T c : cs) {
      ...
      for (ast.dec.T dec : cc.decs) {//java.util.LinkedList<ast.dec.T> decs;
        dec.accept(this);//!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      for (ast.method.T mthd : methods) {
        ...
        newArgs.add(new codegen.C.dec.Dec(new codegen.C.type.Class(cc.id), "this"));
